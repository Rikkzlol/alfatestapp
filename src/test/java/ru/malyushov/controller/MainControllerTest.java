package ru.malyushov.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import ru.malyushov.service.serviceimplementation.GifServiceImpl;
import ru.malyushov.service.serviceimplementation.OpenExchangeRatesServiceImpl;
...
public class MainControllerTest {
    ...
    public void whenrReturnListOfCharCodes() throws Exception {
        ...
        mockMvc.perform(get("/main/valuecodes")
    ...
    public void whenReturnRichGif() throws Exception {
        ...
        mockMvc.perform(get("/main/gif/TESTCODE")
                        .contentType(MediaType.APPLICATION_JSON))
                .andDo(print())
